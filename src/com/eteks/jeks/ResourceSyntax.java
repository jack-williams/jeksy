...
public abstract class ResourceSyntax extends AbstractSyntax
{
    ...
    /**
     * Creates an instance of <code>ResourceSyntax</code> initialized with the
    ...
    public ResourceSyntax(ResourceBundle resourceBundle)
    {
        ...
        setResourceUnaryOperatorKey("OPERATOR_LOGICAL_NOT",
                OPERATOR_LOGICAL_NOT);
        setResourceUnaryOperatorKey("OPERATOR_BITWISE_NOT",
        ...
        setResourceBinaryOperatorKey("OPERATOR_GREATER_OR_EQUAL",
                OPERATOR_GREATER_OR_EQUAL);
        setResourceBinaryOperatorKey("OPERATOR_LESS_OR_EQUAL",
        ...
        setResourceBinaryOperatorKey("OPERATOR_LOGICAL_XOR",
                OPERATOR_LOGICAL_XOR);
        setResourceBinaryOperatorKey("OPERATOR_LOGICAL_AND",
                OPERATOR_LOGICAL_AND);
        setResourceBinaryOperatorKey("OPERATOR_BITWISE_OR", OPERATOR_BITWISE_OR);
        setResourceBinaryOperatorKey("OPERATOR_BITWISE_XOR",
                OPERATOR_BITWISE_XOR);
        setResourceBinaryOperatorKey("OPERATOR_BITWISE_AND",
                OPERATOR_BITWISE_AND);
        setResourceBinaryOperatorKey("OPERATOR_SHIFT_LEFT", OPERATOR_SHIFT_LEFT);
        setResourceBinaryOperatorKey("OPERATOR_SHIFT_RIGHT",
                OPERATOR_SHIFT_RIGHT);
        setResourceBinaryOperatorKey("OPERATOR_SHIFT_RIGHT_0",
        ...
        setResourceBinaryOperatorPriority("OPERATOR_PRIORITY_SUBSTRACT",
                OPERATOR_SUBSTRACT);
        setResourceBinaryOperatorPriority("OPERATOR_PRIORITY_MODULO",
                OPERATOR_MODULO);
        setResourceBinaryOperatorPriority("OPERATOR_PRIORITY_DIVIDE",
                OPERATOR_DIVIDE);
        setResourceBinaryOperatorPriority("OPERATOR_PRIORITY_MULTIPLY",
                OPERATOR_MULTIPLY);
        setResourceBinaryOperatorPriority("OPERATOR_PRIORITY_POWER",
                OPERATOR_POWER);
        setResourceBinaryOperatorPriority("OPERATOR_PRIORITY_LOGICAL_OR",
                OPERATOR_LOGICAL_OR);
        setResourceBinaryOperatorPriority("OPERATOR_PRIORITY_LOGICAL_XOR",
                OPERATOR_LOGICAL_XOR);
        setResourceBinaryOperatorPriority("OPERATOR_PRIORITY_LOGICAL_AND",
                OPERATOR_LOGICAL_AND);
        setResourceBinaryOperatorPriority("OPERATOR_PRIORITY_BITWISE_OR",
                OPERATOR_BITWISE_OR);
        setResourceBinaryOperatorPriority("OPERATOR_PRIORITY_BITWISE_XOR",
                OPERATOR_BITWISE_XOR);
        setResourceBinaryOperatorPriority("OPERATOR_PRIORITY_BITWISE_AND",
                OPERATOR_BITWISE_AND);
        setResourceBinaryOperatorPriority("OPERATOR_PRIORITY_SHIFT_LEFT",
                OPERATOR_SHIFT_LEFT);
        setResourceBinaryOperatorPriority("OPERATOR_PRIORITY_SHIFT_RIGHT",
                OPERATOR_SHIFT_RIGHT);
        setResourceBinaryOperatorPriority("OPERATOR_PRIORITY_SHIFT_RIGHT_0",
                OPERATOR_SHIFT_RIGHT_0);
        setResourceBinaryOperatorPriority("OPERATOR_PRIORITY_EQUAL",
                OPERATOR_EQUAL);
        setResourceBinaryOperatorPriority("OPERATOR_PRIORITY_DIFFERENT",
                OPERATOR_DIFFERENT);
        setResourceBinaryOperatorPriority("OPERATOR_PRIORITY_GREATER_OR_EQUAL",
                OPERATOR_GREATER_OR_EQUAL);
        setResourceBinaryOperatorPriority("OPERATOR_PRIORITY_LESS_OR_EQUAL",
                OPERATOR_LESS_OR_EQUAL);
        setResourceBinaryOperatorPriority("OPERATOR_PRIORITY_GREATER",
                OPERATOR_GREATER);
        setResourceBinaryOperatorPriority("OPERATOR_PRIORITY_LESS",
                OPERATOR_LESS);
    ...
    public void setResourceConstantKey(String resourceName, Object constantKey)
    {
            ...
            Object binaryOperatorKey)
    {
        ...
        if (binaryOperatorPriority != null)
            setBinaryOperatorPriority(binaryOperatorKey,
                    Integer.parseInt(binaryOperatorPriority));
    }
