...
import com.eteks.codec.JeksCodecFactory;
import com.eteks.jeks.JeksTable.MODE;
import com.eteks.parser.CompilationException;
import com.eteks.parser.CompiledFunction;
import com.eteks.gui.HTMLDocumentViewer;
import com.eteks.gui.SplashScreenWindow;
...
public class JeksFrame extends JFrame
{
    ...
    private ResourceBundle resourceBundle = ResourceBundle
            .getBundle("com.eteks.jeks.resources.jeks");
    ...
    {
        JButton newSpreadSheetButton;
        JButton newTypeSheetButton;
        JButton newFunctionSheetButton;
        JButton openButton;
        JButton saveButton;
        ...
        JButton copyButton;
        JButton pasteButton;
        JButton testModeButton;

        public JeksToolBar()
        {
            Icon newSpreadsheetIcon = new ImageIcon(getClass().getResource(
                    "/toolbarButtonGraphics/general/New16.gif"));
            Icon newTypesheetIcon = new ImageIcon(getClass().getResource(
                    "/toolbarButtonGraphics/general/New16.gif"));
            Icon newFunctionsheetIcon = new ImageIcon(getClass().getResource(
                    "/toolbarButtonGraphics/general/New16.gif"));
            ...
            Icon cutIcon = new ImageIcon(getClass().getResource(
                    "/toolbarButtonGraphics/general/Cut16.gif"));
            Icon copyIcon = new ImageIcon(getClass().getResource(
                    "/toolbarButtonGraphics/general/Copy16.gif"));
            Icon pasteIcon = new ImageIcon(getClass().getResource(
                    "/toolbarButtonGraphics/general/Paste16.gif"));

            Icon toggleTestMode = new ImageIcon(getClass().getResource(
                    "/toolbarButtonGraphics/general/New16.gif"));

            newSpreadSheetButton = new ToolBarButton(newSpreadsheetIcon);
            newTypeSheetButton = new ToolBarButton(newTypesheetIcon);
            newFunctionSheetButton = new ToolBarButton(newFunctionsheetIcon);
            ...
            testModeButton = new ToolBarButton(toggleTestMode);

            newSpreadSheetButton.addActionListener(newSpreadsheetAction);
            newTypeSheetButton.addActionListener(newTypesheetAction);
            newFunctionSheetButton.addActionListener(newFunctionsheetAction);
            ...
            testModeButton.addActionListener(toggleTestModeAction);

            add(newSpreadSheetButton);
            add(newTypeSheetButton);
            add(newFunctionSheetButton);
            add(openButton);
            add(saveButton);
            addSeparator();
            add(cutButton);
    ...
    private class JeksMenuBar extends MenuBar
    {
        ...
        public JeksMenuBar()
        {
            ...
            newMenuItem.addActionListener(newSpreadsheetAction);
        ...
        private void loadMenuLabel(MenuItem menuItem, String resource)
        {
            ...
            if (mnemonicIndex >= 0)
                menuItem.setLabel(menuString.substring(0, mnemonicIndex)
                        + menuString.substring(mnemonicIndex + 1));
            else
                menuItem.setLabel(menuString);
        }
    }

    // Menu bar for other OS (MacOS X should set the property
    ...
    private class JeksJMenuBar extends JMenuBar
    {
        ...
        JMenuItem listFunctionsMenuItem = new JMenuItem();
        ...
        public JeksJMenuBar()
        {
            ...
            loadMenuLabel(eraseMenuItem, "EDIT_DELETE_MENU");
            loadMenuLabel(newFunctionMenuItem, "TOOLS_NEW_FUNCTION_MENU");
            loadMenuLabel(listFunctionsMenuItem, "TOOLS_LIST_FUNCTION_MENU");
            loadMenuLabel(helpMenuItem, "HELP_HELP_MENU");
            loadMenuLabel(aboutMenuItem, "HELP_ABOUT_MENU");
            ...
            loadMenuLabel(toolsMenu, "TOOLS_MENU");
            toolsMenu.add(newFunctionMenuItem);
            toolsMenu.add(listFunctionsMenuItem);
            ...
            eraseMenuItem.addActionListener(eraseAction);
            newFunctionMenuItem.addActionListener(newFunctionAction);
            listFunctionsMenuItem.addActionListener(listFunctionsAction);
            helpMenuItem.addActionListener(helpAction);
            aboutMenuItem.addActionListener(aboutAction);
        }
        ...
        private void loadMenuLabel(JMenuItem menuItem, String resource)
        {
            ...
            if (mnemonicIndex >= 0)
            {
                menuItem.setText(menuString.substring(0, mnemonicIndex)
                        + menuString.substring(mnemonicIndex + 1));
    ...
    private ActionListener newSpreadsheetAction = new ActionListener()
    {
        public void actionPerformed(ActionEvent event)
        {
            if (confirmCloseDocument())
            {
                Object inputValue = JOptionPane
                        .showInputDialog("Name of new Spread Sheet");
                if (inputValue == null)
                {
                    return; // Cancel was pressed
                }
                JFrame frame = new JeksFrame(JeksFrame.state,
                        (String) inputValue);
    ...
    private ActionListener newTypesheetAction = new ActionListener()
    {
        public void actionPerformed(ActionEvent event)
        {
            if (confirmCloseDocument())
            {
                String inputValue = JOptionPane
                        .showInputDialog("Name of new Type Sheet");
                if (inputValue == null)
                {
                    return; // Cancel was pressed
                }
                JFrame frame = new JeksFrame(JeksFrame.state, inputValue,
                        JeksTable.MODE.TYPESHEET);
                frame.setVisible(true);
                frame.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
                frameCount++;
            }
    ...
    private ActionListener newFunctionsheetAction = new ActionListener()
    {
        public void actionPerformed(ActionEvent event)
        {
            if (confirmCloseDocument())
            {
                String inputValue = JOptionPane
                        .showInputDialog("Name of new Function Sheet");
                if (inputValue == null)
                {
                    return; // Cancel was pressed
                }
                JFrame frame = new JeksFrame(JeksFrame.state, inputValue,
                        JeksTable.MODE.FUNCTIONSHEET);
                frame.setVisible(true);
                frame.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
                frameCount++;
            }
        ...
        public void actionPerformed(ActionEvent event)
        {
            SwingUtilities.invokeLater(new Runnable()
            {
                public void run()
                {
                    ...
                    {
                        JeksExpressionSyntax syntax = (JeksExpressionSyntax) ((JeksTable) table)
                                .getExpressionParser().getSyntax();
    ...
    private ActionListener listFunctionsAction = new ActionListener()
    {
        public void actionPerformed(ActionEvent event)
        {
    ...
    private ActionListener helpAction = new ActionListener()
    {
        public void actionPerformed(ActionEvent event)
        {
            if (helpViewer == null)
            {
                ...
                helpViewer.setPage(ClassLoader.getSystemResource(resourceBundle
                        .getString("HELP_FILE")));
    ...
    private ActionListener toggleTestModeAction = new ActionListener()
    {
        public void actionPerformed(ActionEvent event)
        {
            ((JeksTable) JeksFrame.this.table).toggleTestMode();
        }
    };
     ...
     */
    public JeksFrame(SharedState state, String name)
    {
        this(state, name, JeksTable.MODE.SPREADSHEET);
    }

    /**
     * Creates a frame with an empty table.
     */
    public JeksFrame(SharedState state, String name, JeksTable.MODE mode)
    {
        super(name);
        ...
        // Create a jeks table
        setTable(new JeksTable(state, name, mode));
        ...
        textField.addActionListener(new ActionListener()
        {
            public void actionPerformed(ActionEvent e)
            {
                ...
                if (table.getCellEditor(0, 0) instanceof JeksCellEditor)
                {
                    ...
                    Object value = ((JeksCellEditor) table.getCellEditor(0, 0))
                            .getModelValue(
                                    text,
                                    table.getModel(),
                                    new JeksCell(editedRow, table
                    ...
                    if (value != null)
                    {
                        ...
                        table.setRowSelectionInterval(editedRow + 1,
                                editedRow + 1);
                    }
                }
            }
        ...
        if (os.indexOf("mac") >= 0 && os.indexOf("mac os x") < 0)
            setMenuBar(new JeksMenuBar());
        else
            setJMenuBar(new JeksJMenuBar());

        URL iconURL = ClassLoader
                .getSystemResource("com/eteks/jeks/resources/jeksicon.gif");
    ...
    public void setTable(final JTable table)
    {
        ...
        TableModel rowHeaderModel = new AbstractTableModel()
        {
            ...
            {
                return table instanceof JeksTable ? ((JeksExpressionSyntax) ((JeksTable) table)
                        .getExpressionParser().getSyntax()).getRowName(row)
        ...
        // rowHeaderTable.getColumn (rowHeaderTable.getColumnName
        // (0)).setCellRenderer (table.getTableHeader ().getDefaultRenderer ());
        // rowHeaderTable.getColumn (rowHeaderTable.getColumnName
        // (0)).setCellRenderer (table.getTableHeader ().getColumnModel
        // ().getColumn
        // (0).getHeaderRenderer ());
        DefaultTableCellRenderer renderer = new DefaultTableCellRenderer()
        {
            public Component getTableCellRendererComponent(JTable table,
                    ...
                    int row, int column)
            {
                setForeground(JeksFrame.this.table.getTableHeader()
                        .getForeground());
                setBackground(JeksFrame.this.table.getTableHeader()
                        .getBackground());
        ...
        rowHeaderTable.getColumn(rowHeaderTable.getColumnName(0))
                .setCellRenderer(renderer);
        rowHeaderTable.getColumn(rowHeaderTable.getColumnName(0))
                .setPreferredWidth(50);
        // Set a text to the renderer to have a valid preferred size
        renderer.setText("1");
        rowHeaderTable.setPreferredScrollableViewportSize(rowHeaderTable
                .getPreferredSize());
        ...
        final ListSelectionListener selectionListener = new ListSelectionListener()
        {
            public void valueChanged(ListSelectionEvent e)
            {
                ...
                if (table instanceof JeksTable)
                    value = ((JeksTable) table).getExpressionParser()
    ...
    private boolean confirmCloseDocument()
    {
        ...
        switch (JOptionPane.showConfirmDialog(this,
                resourceBundle.getString("MODIFIED_DOCUMENT_DIALOG_TEXT"),
                ...
                SwingUtilities.invokeLater(new Runnable()
                {
                    public void run()
                    {
                        ...
                        try
                        {
                            ...
                            // Read in a new table
                            String[] foo = chooser.getSelectedFile().getName()
                                    .split("\\.");                            
                            String name = foo[0];
                            JeksFrame newFrame = new JeksFrame(state, name);

                            com.eteks.codec.JeksCodec codec = JeksCodecFactory
                                    .getCodecInstance(in, name, state);
                            in.close();
                            in = new FileInputStream(chooser.getSelectedFile());

                            newFrame.setTable(codec.decode(in));
                            in.close();
                            newFrame.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
                            frameCount++;
                            newFrame.setVisible(true);
                            currentFile = chooser.getSelectedFile();
                            newFrame.setTitle (TITLE_BASE + " - " + currentFile.getName ());
                        } catch (IOException e)
                        {
                            JOptionPane.showMessageDialog(JeksFrame.this,
                                    e.getMessage(),
                                    resourceBundle.getString("FILE_OPEN_MENU"),
            ...
            SwingUtilities.invokeLater(new Runnable()
            {
                public void run()
                {
                    ...
                    try
                    {
                        ...
                        JTable table = getTable();
                        com.eteks.codec.JeksCodec codec = new com.eteks.codec.JeksCodec(
                                table, state);
                        codec.encode(out, table);
                    ...
                    } catch (IOException e)
                    {
                        JOptionPane.showMessageDialog(JeksFrame.this,
                                e.getMessage(),
                                resourceBundle.getString("FILE_SAVE_MENU"),
                                JOptionPane.ERROR_MESSAGE);
                    } finally
                    {
                        try
                    ...
                    try
                    {
                        ...
                        JeksTable tbl = (JeksTable) JeksFrame.this.getTable();
                        in = new FileInputStream(currentFile);
                        com.eteks.codec.JeksCodec codec = com.eteks.codec.JeksCodecFactory
                                .getCodecInstance(tbl, state);
                        codec.update(in);
    ...
    private void saveAsDocument()
    {
        ...
        if (chooser.showSaveDialog(JeksFrame.this) == JFileChooser.APPROVE_OPTION)
        {
            ...
            if (!savedFile.getName().toLowerCase().endsWith(".jks"))
                savedFile = new File(savedFile.getParent(), savedFile.getName()
                        + ".jks");
    ...
    private void createNewFunction()
    {
        ...
        if (table instanceof JeksTable)
            while (function == null)
                try
                {
                    if ((functionDef = (String) JOptionPane.showInputDialog(
                            JeksFrame.this, resourceBundle
                                    .getString("NEW_FUNCTION_DIALOG_TEXT"),
                            resourceBundle
                                    .getString("NEW_FUNCTION_DIALOG_TITLE"),
                            JOptionPane.PLAIN_MESSAGE, null, null, functionDef)) == null)
                        return;
                    function = ((JeksTable) table).getExpressionParser()
                            .getFunctionParser().compileFunction(table.getModel(), functionDef);
                    ((JeksTable) table).getExpressionParser().addUserFunction(
                            function);
                    tableChanged = true;
                } catch (CompilationException ex)
                {
                    JeksFunctionSyntax syntax = (JeksFunctionSyntax) ((JeksTable) table)
                            .getExpressionParser().getFunctionParser()
                            .getSyntax();
                    ...
                    JOptionPane
                            .showMessageDialog(
                                    JeksFrame.this,
                                    errorMessage,
                                    syntax.getMessage(JeksExpressionSyntax.MESSAGE_COMPILATION_ERROR_TITLE),
                                    JOptionPane.ERROR_MESSAGE);
                }
    }
    ...
    public static void main(String args[]) throws Exception
    {
        ...
        URL splashImageURL = ClassLoader
                .getSystemResource("com/eteks/jeks/resources/jeksscreen.jpg");
        SplashScreenWindow splashScreen = new SplashScreenWindow(Toolkit
                .getDefaultToolkit().getImage(splashImageURL), 5000);
        ...
        JFrame frame = new JeksFrame(JeksFrame.state, "untitled");
        frame.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
        frameCount++;
        splashScreen.join();
